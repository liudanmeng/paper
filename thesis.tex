...
\pkuthssinfo{
    ...
    ctitle = {基于复杂网络的高速公路关键路段挖掘}, etitle = {Test Document},
    cauthor = {刘丹萌},
    eauthor = {Test},
    studentid = {1401214385},
    date = {2017年5月10日},
    school = {北京大学},
    cmajor = {智能科学与技术(计算机科学与技术)}, emajor = {Some Major},
    direction = {数据挖掘},
    cmentor = {宋国杰}, ementor = {Prof.\ Somebody},
    ckeywords = {复杂网络，高速公路，关键节点}, ekeywords = {Complex network, Highway，Key node}
}
